            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Input className="input-class focus-visible: focus-visible:ring-offset-orange-1" placeholder="Podcast name.." {...field} />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Textarea className="input-class focus-visible: focus-visible:ring-offset-orange-1" placeholder="Write a short podcast description" {...field} />
                  </FormControl>
